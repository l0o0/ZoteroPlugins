...
自动更新于： `2023-09-14 09:58:17.914067`，国内用户建议使用 **国内镜像** 下载链接。插件间可能存在冲突，强烈建议按需获取安装
...
Zotero 中文小组已经有了新的赛博根据地了，请点击[链接](https://zotero-chinese.com/)  

[新的插件市场](https://plugins.zotero-chinese.com/#/)
