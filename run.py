...
if update_flag == 1:
    ...
    gitee_url = "https://gitee.com/zotero-chinese/zotero-plugins/raw/main/plugins"
    for _i, plugin in enumerate(new_plugins_source):
        ...
        download_link_gitee = gitee_url + "/%s/%s" % (plugin['addon'].replace(" ", '_').lower(), plugin['filename'])
